...
import { registerClient, getClient, updateClient, editClient, formClient } from '../../actions/client';
...
export class ClientForm extends React.Component {
  ...
  onSubmit = e => {
    ...
    if(this.state.isEditing == true){
        this.props.updateClient(this.state.id, data);
        this.onReset();
    }else
    {
    ...
    if(this.props.isEdit > -1){
      this.loadEditState(this.props.isEdit, this.props.clients)
    }
    ...
    return (
        ...
        <Col >
          <Card body>
            <CardHeader>
            <CardTitle><h4>Add/Edit Client</h4></CardTitle>
            </CardHeader>
