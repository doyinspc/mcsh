...
import { loginEmployee } from "../../actions/employee";
...
class LoginPage extends React.Component{
  ...
  onSubmit = e => {
    e.preventDefault();
    this.props.loginEmployee(this.state.email, this.state.password);
  };
  ...
  render(){ 
    if (this.props.isAuthenticated) {
      return <Redirect to="/employee-file/1" />;
    }
...
export default connect(mapStateToProps, { loginEmployee })(LoginPage);
